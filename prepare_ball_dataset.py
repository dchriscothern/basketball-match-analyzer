...
def main() -> None:
    parser = argparse.ArgumentParser(description="Prepare a bootstrap basketball ball-detector dataset from one local clip")
    ...
    analysis_path, analysis_label = prepare_analysis_source(video_path, args.analysis_profile)
    ...
    print(f"Prepared clip: {analysis_path} ({analysis_label})")
    ...
    print(
        ...
        "train_ball_detector.py --data datasets\\ball_detector_template.yaml --epochs 40 --imgsz 960 --batch 8"
    )
